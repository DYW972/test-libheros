...
var Task = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('task')];
    ...
    var _taskList_extraInitializers = [];
    var Task = _classThis = /** @class */ (function () {
        function Task_1() {
            ...
            this.taskList = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _taskList_initializers, void 0));
            __runInitializers(this, _taskList_extraInitializers);
        }
        return Task_1;
    }());
    ...
    (function () {
        ...
        _status_decorators = [(0, typeorm_1.Column)({ type: 'enum', enum: task_enum_1.TaskStatus, default: task_enum_1.TaskStatus.TODO })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)()];
        _taskList_decorators = [(0, typeorm_1.ManyToOne)(function () { return tasks_list_entity_1.TasksList; }, function (tasksList) { return tasksList.tasks; }, {
                onDelete: 'CASCADE',
            })];
        ...
        __esDecorate(null, null, _taskList_decorators, { kind: "field", name: "taskList", static: false, private: false, access: { has: function (obj) { return "taskList" in obj; }, get: function (obj) { return obj.taskList; }, set: function (obj, value) { obj.taskList = value; } }, metadata: _metadata }, _taskList_initializers, _taskList_extraInitializers);
