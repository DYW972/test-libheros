...
var TaskService = function () {
    ...
    var TaskService = _classThis = /** @class */ (function () {
        function TaskService_1(taskRepository, taskListRepository) {
        ...
        TaskService_1.prototype.create = function (createTaskDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.taskListRepository.findOneBy({
                                id: createTaskDto.taskListId,
                            })];
                        case 1:
                            taskList = _a.sent();
                            if (!taskList) {
                                throw new common_1.NotFoundException('TaskList not found');
                            }
                            task = this.taskRepository.create(__assign(__assign({}, createTaskDto), { taskList: taskList }));
                            return [2 /*return*/, this.taskRepository.save(task)];
                    }
                });
            });
        };
        TaskService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskRepository.find({ relations: ['taskList'] })];
                });
            });
        };
        ...
        TaskService_1.prototype.findByTaskList = function (taskListId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskRepository.find({
