...
var task_gateway_1 = require("./task.gateway");
var task_controller_1 = require("./task.controller");
var tasks_list_entity_1 = require("../tasks-list/tasks-list.entity");
var TaskModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([task_entity_1.Task, tasks_list_entity_1.TasksList])],
            controllers: [task_controller_1.TaskController],
            providers: [task_service_1.TaskService, task_gateway_1.TaskGateway],
