...
var UserController = function () {
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.delete = function (id) {
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Get)()];
        _findOne_decorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Get)(':id')];
        _update_decorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Put)(':id')];
        _delete_decorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Delete)(':id')];
